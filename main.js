...
const player = document.getAnimations("player")
...
const setNumbers = () => {
    ...
    // cases[0].innerHTML = casesArray[0];
    // cases[0].onclick = () => check(casesArray[0]);
    // cases[1].innerHTML = casesArray[1];
    // cases[0].onclick = () => check(casesArray[0]);
    // cases[2].innerHTML = casesArray[2];
    // cases[0].onclick = () => check(casesArray[0]);
    // cases[3].innerHTML = casesArray[3];
    // cases[0].onclick = () => check(casesArray[0]);
    for (let i = 0; i < 4; i++) {
